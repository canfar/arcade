...
class CADCAlmaClass(AlmaClass):
    ...
    def query_obsdate_async(self, oldest_observation, newest_observation, cache=True, public=True,
        ...
        payload.update({'start_date': "{}-{}-{}..{}-{}-{}".format(d1.tm_mday, d1.tm_mon, d1.tm_year,
...
if __name__ == "__main__":
    ...
    oldest_data = Time("2016-01-01 00:00:00", out_subfmt='date')
    newest_data = Time("2016-02-01 00:00:00", out_subfmt='date')
    print CADCAlmaClass().query_obsdate_async(oldest_data, newest_data)
